...
<body>
	<div class="container-md">
        ...
        <table class="table" style="text-align: center;">
            ...
            <tbody>
                <tr>
                    <td><a href=""><img class="product_img" src="img/01.png" alt="제품 상세 페이지"></a></td>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-3 input-group">
                <input type="text" class="form-control" aria-label="readonly input example"
            readonly data-bs-toggle="modal" data-bs-target="#addressInputModal">
                <button id="addressSearchBtn" class="btn btn-outline-secondary" type="button" data-bs-toggle="modal" data-bs-target="#addressInputModal">주소검색</button>
            </div>
            <div class="row adress-input">
            <input id="mainAddress" class="form-control" type="text" placeholder="주소" aria-label="readonly input example"
            readonly style="margin-right: 10px;">
            <input id="detailAddress" class="form-control" type="text" placeholder="상세주소">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button id="addressSubmitBtn" type="button" class="btn btn-primary" data-bs-dismiss="modal">입력</button>
      </div>
    </div>
  </div>
</div>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-OERcA2EqjJCMA+/3y+gxIOqMEjwtxJY7qPCqsdltbNJuaOe923+mo//f6V8Qbsw3" crossorigin="anonymous"></script>
 ...
 document.querySelector("#addressSubmitBtn").addEventListener("click", function(){
