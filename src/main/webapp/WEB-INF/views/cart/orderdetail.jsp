    ...
    <div class="container-md" style="text-align: center;">
        ...
        <table class="table" style="vertical-align: middle;">
        	<thead>
				...
				<tr>
					<td><a href="/detail/${orderDetailList.b_code }" target="_blank"><img src="https://bookproject-20221208.s3.ap-northeast-2.amazonaws.com/book/${orderDetailList.b_code }/${URLEncoder.encode(orderDetailList.b_img,'utf-8')}" alt="제품 사진" style="width: 100px; height: 150px;" class="product_img"/></a></td>
